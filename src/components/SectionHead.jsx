...
/** Numbered mono eyebrow over a large statement. Used by every section. */
export default function SectionHead({ index, eyebrow, title, children }) {
    return (
        <header className="sechead">
            <div className="sechead__eyebrow reveal">
                <span className="label">{index}</span>
                <span className="sechead__tick" />
